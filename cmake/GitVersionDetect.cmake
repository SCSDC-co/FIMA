...
if(NOT DEFINED GITVERSIONDETECT_VERSION)
    ...
    message(
        WARNING
            "Failed to determine GITVERSIONDETECT_VERSION from Git tags. Using default version \"${GITVERSIONDETECT_VERSION}\"."
    )
endif()
...
set(GITVERSIONDETECT_VERSION_PRETTY
    "${CMAKE_MATCH_1}.${CMAKE_MATCH_2}.${CMAKE_MATCH_3}-${GIT_HASH}"
)

message(STATUS "Version detected:")
message(STATUS "  major: ${GITVERSIONDETECT_VERSION_MAJOR}")
message(STATUS "  minor: ${GITVERSIONDETECT_VERSION_MINOR}")
message(STATUS "  patch: ${GITVERSIONDETECT_VERSION_PATCH}")
message(STATUS "  pretty: ${GITVERSIONDETECT_VERSION_PRETTY}")
