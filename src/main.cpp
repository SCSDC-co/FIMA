...
main(int argc, char** argv)
{
    ...
    app
      .add_option(
        "directory", path, "Directory to work on (default current directory)")
    ...
    create_subcmd->add_option(
      "path", path_to_create_or_remove, "File or dir to create");
    ...
    remove_subcmd->add_option(
      "path", path_to_create_or_remove, "File or directory to remove");
    ...
    copy_subcmd->add_option(
      "source-file", path_to_copy, "File or directory copy");
    ...
    rename_subcmd->add_option(
      "old-name", old_name, "File or directory to move or rename");
    rename_subcmd->add_option(
      "new-name", new_name, "The new name for the directory or file");
    ...
    perms_subcmd->add_option(
      "path", perms_path, "The file path to read permissions from");
